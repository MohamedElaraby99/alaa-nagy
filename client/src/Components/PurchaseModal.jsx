          ...
          <div className="p-6">
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center mx-auto mb-4">
                <FaCheck className="text-blue-600 dark:text-blue-400 text-2xl" />
              </div>
              ...
              <button
                onClick={onClose}
                className="w-full bg-gradient-to-r from-blue-500 to-sky-600 text-white py-3 px-6 rounded-xl font-semibold hover:from-blue-600 hover:to-sky-700 transition-all duration-200"
              >
                فهمت
              </button>
            </div>
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center">
      ...
      <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full mx-4 overflow-hidden">
        {/* Success Animation */}
        {showSuccess && (
          <div className="absolute inset-0 bg-blue-500/90 flex items-center justify-center z-10">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-blue-50 dark:from-blue-900/20 dark:to-blue-900/20 rounded-xl p-4 mb-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className={`font-semibold ${canAfford ? 'text-blue-600 dark:text-blue-400' : 'text-red-600 dark:text-red-400'}`}>
                  {balance} نقطة
                </span>
              </div>
            </div>
          ...
          <div className="space-y-3">
            {canAfford ? (
              <button
                ...
                disabled={loading}
                className="w-full bg-gradient-to-r from-blue-500 to-sky-600 text-white py-4 px-6 rounded-xl font-semibold hover:from-blue-600 hover:to-sky-700 transition-all duration-200 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-3"
              >
                {loading ? (
                  <>
