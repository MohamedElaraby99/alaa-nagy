...
const PurchaseSuccess = ({ 
  ...
  return (
    <div className="fixed top-4 right-4 z-[70]">
      <div className={`
        bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-blue-200 dark:border-blue-800 
      ...
      `}>
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-sky-600 rounded-full flex items-center justify-center animate-pulse">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-100 dark:bg-gray-700 rounded-full h-2 overflow-hidden">
            <div className="bg-gradient-to-r from-blue-500 to-sky-600 h-full rounded-full animate-pulse" style={{ width: '100%' }} />
          </div>
        </div>
      </div>
    </div>
